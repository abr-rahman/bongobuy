...
class UserDashboardController extends Controller
{
    ...
    {
        $user = User::select('id', 'email', 'profile_photo', 'name')->where('email', auth()->user()->email)->first();
        ...
        return view('frontend.dashboard.index', compact('user', 'wishlist', 'order', 'dealer', 'supports'));
    }
