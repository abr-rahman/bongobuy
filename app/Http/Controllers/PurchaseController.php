...
use App\DataTables\BrandWisePurchaseDataTable;
use App\DataTables\BrandWisePurchaseListDataTable;
...
class PurchaseController extends Controller
{
    public function index(Request $request, PurchaseDataTable $dataTable)
    {
        ...
        // return view('admin.purchase.old-index', compact('purchases'));
    }
    ...
    public function brandWisePurchase($id, BrandWisePurchaseDataTable $dataTable)
    {
        $dataTable->setBrandId($id);
        return $dataTable->render('admin.purchase.product');
    }
    public function brandWisePurchaseList($id, BrandWisePurchaseListDataTable $dataTable)
    {
        $dataTable->setBrandId($id);
        return $dataTable->render('admin.purchase.index');
    }
