...
class BkashTokenizePaymentController extends Controller
{
    ...
    {
        // return view('ecommerce::bkash.bkash-payment');
        return view('bkashT::bkash-payment');
    }
    public function createPayment(Request $request)
    {
        // dd(1);
        // $service_request = Order::findOrFail($service_request_id);
        $inv = uniqid();
        $request['intent'] = 'sale';
        ...
        if (isset($response['bkashURL'])) {
            // $service_request->payment_id = $response['paymentID'];
            // $service_request->payment_method = 'bkash';
            // $service_request->payment_created_at = Carbon::now();
