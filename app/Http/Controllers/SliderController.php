...
class SliderController extends Controller
{
    ...
    {
        $this->sliderService->addOutlet($id);
        return response()->json(['Status changed successfully!']);
    }
    public function removeOutlet($id)
    {
        $this->sliderService->removeOutlet($id);
        return response()->json(['Status changed successfully!']);
    }
    public function addBannar($id)
    {
        $this->sliderService->addBannar($id);
        return response()->json(['Status changed successfully!']);
    }
    public function removeBannar($id)
    {
        $this->sliderService->removeBannar($id);
        return response()->json(['Status changed successfully!']);
    }
}
