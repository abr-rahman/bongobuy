...
class ProductPriceController extends Controller
{
    ...
    public function changePrice($id)
    {
        ...
        $userPrice = RegularPrice::select('id', 'regular_price', 'discount_fixed', 'discount_percentage', 'lowest_price', 'product_id')->where('product_id', $product->id)->first();
    ...
    public function priceUpdateRegular(Request $request, $id)
    {
        ...
        $regularPrice->lowest_price = $request->lowest_price ?? 00;
        $regularPrice->save();
