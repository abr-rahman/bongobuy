...
class BrandWiseProductDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('a_status', function ($row) {
                ...
                if ($row->a_status == ProductStatus::Arrival->value) {
                    $html = '<div class="col-sm-5"><a class="btn bg-dark badge">Arrival</a> </div>';
                    return $html;
                }
            })
            ...
            ->addColumn('action', function ($row) {
                ...
                if ($row->status == ProductStatus::Active->value) {
                    $html .= '<a class="dropdown-item border" id="check_status" href="' . route('product.featured', $row->id) . '">Add Featured</a>';
                    $html .= '<a class="dropdown-item" id="check_status" href="' . route('product.comming', $row->id) . '">Add Coming Soon </a>';
                ...
                if ($row->a_status == ProductStatus::Featured->value) {
                    $html .= '<a class="dropdown-item border"  id="check_status" href="' . route('product.featured_remove', $row->id) . '">Remove Featured</a>';
                }
