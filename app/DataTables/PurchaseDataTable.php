...
class PurchaseDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                $html .= '<a class="btn" href="' . route('purchase.qr_code_print', $row->id) . '">QR Download</a>';
                $html .= '</div>';
                $html .= '</div>';
    ...
    {
        return $model->newQuery()->select('id', 'invoice_number', 'quantity', 'product_id', 'color_id', 'created_at')->orderBY('created_at', 'desc');
    }
