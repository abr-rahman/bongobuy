        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <x-nav-group :icon="'nav-icon fas fa-baby-carriage'" :name="'Offline'" :prefix="'admin/offline*'">
            <x-nav-ul :prefix="'admin/offline'">
              ...
              <x-nav-li :route="'offline.order.index.pending'">
                {{ __('Pending Order') }}
              </x-nav-li>
              <x-nav-li :route="'offline.order.index.cancel'">
                {{ __('Cancel Order') }}
              </x-nav-li>
              <x-nav-li :route="'offline.order.index.return'">
                {{ __('Return Order') }}
              </x-nav-li>
            </x-nav-ul>
          </x-nav-group>
          ...
          <x-nav-group :icon="'nav-icon fas fa-book-reader'" :name="'Adjustments'" :prefix="'admin/report*'">
            <x-nav-ul :prefix="'admin/report'">
