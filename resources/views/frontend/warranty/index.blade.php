...
<div class="mx-auto md:container py-10 ">
    <div class="w-full md:w-[650px] mx-auto">
        <div class="bg-fave-500 py-5 text-center relative">
            ...
            xl font-semibold uppercase pb-2">Claim Your Warrenty</h1> 
            <a href="{{ asset('frontend/images/warenty.jpg') }}" target="_blank" class="bg-fave-900 hover:bg-fave-700 text-white md:w-28 w-20 md:h-10 font-medium p-1 rounded mt-2">Guidelines</a>
