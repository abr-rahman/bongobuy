                                ...
                                {{-- @if ($item->size_name != null)
                                    <div class="col-md-12">
                                        <div class="border rounded p-2">
                                            <form method="POST" action="{{ route('additions.update', $color->id) }}"
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Color Name <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" value="{{ $color->color_name }}" name="color_name" class="form-control"  value="{{ $color->color_name }}"
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Color Code <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="color" value="{{ $color->color_code }}" name="color_code" class="form-control" value="{{ $color->color_code }}"
