                        ...
                        <table class="table table-striped" class="brand-border">
                            ...
                            <tfoot class="brand-border">
                                <tr style="border-top: 2px solid #ff9900">
                                    <td class="font-weight-bold brand-border">Total Quantity:</td>
                                    <td class="font-weight-bold brand-border">-</td>
                                    <td class="font-weight-bold brand-border">{{ $totalQuantity }}</td>
                                    <td class="font-weight-bold brand-border">-</td>
                                    <td class="font-weight-bold brand-border">-</td>
                                </tr>
                                <tr>
                                    <td class="border-top-none" colspan="3" >Note : </td>
                                ...
                                <tr>
                                    <td class="border-top-none" colspan="3" ></td>
