                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="hidden" name="selected_product_id" id="selectedProductId">
                                                    <select name="color_id" id="colorId" class="form-control select2">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1" class="flex justify-between pb-0">
                                                        <span> QTY | </span>
                                                        <div class="">
                                                            <span for="exampleInputEmail1" class="text-info">C.Stock = </span>
                                                            <span id="showQuantity"
                                                                class="border-rounded text-center text-info font-weight-bold showQuantity">
                                                            </span>
                                                        </div>
                                                    </label>
                                    ...
                                    <table class="table-auto w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border p-2 text-center">{{ $item->color?->color_name ?? 'N/A' }}</td>
        ...
        $('body').on('change', '#productId', function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#colorId').html(data.inventory);
                    $('.showQuantity').html(data.quantity);
                    $('#selectedProductId').val(data.product_id);
                }
            });
        });
        $('body').on('change', '#colorId', function(e) {
            var color_id = $(this).val();
            var product_id = $("#selectedProductId").val();
            $.ajax({
                type: 'GET',
                url: "{{ route('offline.sale.color-select') }}",
                data: {
                    color_id: color_id,
                    product_id: product_id
                },
