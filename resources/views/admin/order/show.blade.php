                        ...
                        <table class="table table-striped" class="brand-border">
                            <thead>
                                <tr>
                                    ...
                                    <th class="brand-border">Color</th>
                            ...
                            <tbody>
                                ...
                                <tr class="brand-border">
                                    ...
                                    <td class="brand-border">{{ $orderItem?->color?->color_name ?? 'N/A' }}</td>
                            ...
                            <tfoot class="brand-border">
                                ...
                                <tr>
                                    ...
                                    <td class="font-weight-bold brand-border">Discount:</td>
                                    <td class="font-weight-bold brand-border"><strong>&#2547;.</strong> {{ $order->discount_amount }}</td>
                                </tr>
                                <tr>
                                    <td class="border-top-none" colspan="2" ></td>
                                    <td class="font-weight-bold brand-border" >Shipping:</td>
                                    <td class="font-weight-bold brand-border"><strong>&#2547;.</strong> {{ $order->shipping_charge }}</td>
                                </tr>
                                <tr>
                                    <td class="border-top-none" colspan="2" ></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                ...
                                <address>
                                    ...
                                    <strong>Phone : </strong>{{ $order->phone }}<br>
                                    <strong>Email: </strong>{{ $order->email }} <br>
                                    <b>Invoice : </b><span class="badge bg-info">{{ $order->invoice_number }}</span><br>
                                </address>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <table class="table table-striped border">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $orderItem?->color?->color_name ?? 'N/A' }}</td>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-weight-bold"><strong>&#2547;.</strong> {{ $order->shipping_charge }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" ></td>
