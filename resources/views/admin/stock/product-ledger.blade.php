            ...
            <table class="table table-sm table-bordered stock-data">
                <thead>
                    <tr>
                        ...
                        <th class="text-info">{{ __('Color') }}</th>
                ...
                <tfoot>
                    <tr>
                        <th colspan="4" class="text-center">Total Stock Out</th>
                        <th></th>
                        {{-- <th></th> --}}
                    </tr>
                    <tr>
                        ...
                        <th colspan="2" class="h6 text-center font-weight-bold">Total Current Stock</th>
