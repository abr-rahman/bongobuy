                                    ...
                                    <div class="col-md-8">
                                        <div class="border rounded p-2 bg-white">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Business Icon </label>
                                                        <label>Upload new one to replace:</label>
                                                        <input type="file" value="{{ $settings->icon }}" name="icon" class="form-control" placeholder="Business Name">

                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        <img src="{{ asset('uploads/logo/'. $settings->icon) }}" alt="{{ $settings->business_name }}" class="img-fluid" id="icon" width="100"/> <br>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="border rounded p-2 bg-white mt-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                <div class="form-group ">
                                                    <label for="exampleInputEmail1">Youtube Link For Home Section</label>
                                                    <input type="text" value="{{ $settings->youtube_link_two }}" name="youtube_link_two" class="form-control" placeholder="Youtube Home Page Link">
                                                </div>
                                                </div>
                                            </div>
                                        </div>
...
@push('js')
    <script>
        function viewPreview(image) {
            ...
            document.getElementById('icon').src = URL.createObjectURL(image.target.files[0]);
        }
    </script>
@endpush
