                    ...
                    <div class="modal-body">
                        ...
                        <div class="border rounded p-2 bg-white mt-3">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Lowest Price <span class="text-danger">*</span></label>
                                <input type="text" value="{{ $userPrice->lowest_price }}"  name="lowest_price" id="selling_price" class="form-control" placeholder="Selling Price">
