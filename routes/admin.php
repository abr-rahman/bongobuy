...
use App\Http\Controllers\Admin\QtyBasedPriceController;
...
Route::prefix('admin')->middleware('can:isAdmin')->group(function () {
    ...
    Route::prefix('settings')->group(function () {
        Route::middleware('auth')->group(function () {
            ...
            Route::get('privacy/policy', [UtilsController::class, 'privacy'])->name('privacy.policy');
    ...
    Route::name('product.')->prefix('/product')->group(function () {
        ...
        Route::get('brand-wise-product/{id}', [ProductController::class, 'brandWise'])->name('brand_wise');
        Route::get('brand-wise-product-purchase/{id}', [PurchaseController::class, 'brandWisePurchase'])->name('brand_wise_purchase');
        Route::get('brand-wise-product-purchase-list/{id}', [PurchaseController::class, 'brandWisePurchaseList'])->name('brand_wise_purchase_list');
        ...
        Route::get('featured-active/{id}', [ProductController::class, 'addFeatured'])->name('add_featured');
        ...
        Route::get('trending/{id}', [ProductController::class, 'addTrending'])->name('trending.active');
        Route::get('remove/trending/{id}', [ProductController::class, 'removeTrending'])->name('trending.remove');
        Route::get('hot-sale/{id}', [ProductController::class, 'addHotSale'])->name('hot_sale.active');
        Route::get('remove/hot-sale/{id}', [ProductController::class, 'removeHotSale'])->name('hot_sale.remove');

        Route::get('qty-based-price/{id}', [QtyBasedPriceController::class, 'create'])->name('qty_based.price');
        Route::post('qty-based-price/store', [QtyBasedPriceController::class, 'store'])->name('qty_based.price_store');
    });
    ...
    Route::prefix('report')->group(function () {
        ...
        Route::get('/filter-route-offline', [ReportController::class, 'offlineFilter'])->name('filter.route.offline');
    });
    ...
    Route::post('ckeditor/upload-image', [ImageUploaderController::class, 'storeImage'])->name('admin.ck-editor-image.upload');
    ...
    Route::get('sliders/add-outlet/{id}', [SliderController::class, 'addOutlet'])->name('sliders.add_outlet');
    Route::get('sliders/remove-outlet/{id}', [SliderController::class, 'removeOutlet'])->name('sliders.remove_outlet');
    Route::get('sliders/add-bannar/{id}', [SliderController::class, 'addBannar'])->name('sliders.add_bannar');
    Route::get('sliders/remove-bannar/{id}', [SliderController::class, 'removeBannar'])->name('sliders.remove_bannar');
    ...
    Route::name('offline.')->prefix('offline')->group(function () {
        ...
        Route::get('/sale/select/color', [OfflineSaleController::class, 'selectColor'])->name('sale.color-select');
        Route::get('/sale/order', [OfflineSaleController::class, 'orderIndex'])->name('order.index');
        Route::get('/sale/order/pending', [OfflineSaleController::class, 'offlinePendingOrder'])->name('order.index.pending');
        Route::get('/sale/order/cancel', [OfflineSaleController::class, 'cancelOfflineOrder'])->name('order.index.cancel');
        Route::get('/sale/order/return', [OfflineSaleController::class, 'returnOfflineOrder'])->name('order.index.return');
        Route::get('/sale/order/show/{id}', [OfflineSaleController::class, 'orderShow'])->name('order.show');
        Route::get('/sale/order/confirm/{id}', [OfflineSaleController::class, 'orderConfirm'])->name('order.confirm');
        Route::get('/sale/order/cancel/{id}', [OfflineSaleController::class, 'orderCancel'])->name('order.cancel');
        Route::get('/sale/order/edit/{id}', [OfflineSaleController::class, 'orderEdit'])->name('order.edit');
        Route::post('/sale/order/update/{id}', [OfflineSaleController::class, 'orderUpdate'])->name('order.update');
        Route::get('/sale/order/return/{id}', [OfflineSaleController::class, 'orderReturn'])->name('order.return');
